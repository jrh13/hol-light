...
"COMPATIBLE_NORM_FLATTEN",COMPATIBLE_NORM_FLATTEN;
...
"CONTINUOUS_DET_FLATTEN",CONTINUOUS_DET_FLATTEN;
...
"CONTINUOUS_FLATTEN_COMPONENTWISE",CONTINUOUS_FLATTEN_COMPONENTWISE;
...
"CONTINUOUS_MATRIX_FLATTEN",CONTINUOUS_MATRIX_FLATTEN;
...
"CONTINUOUS_ON_DET_FLATTEN",CONTINUOUS_ON_DET_FLATTEN;
...
"CONTINUOUS_ON_FLATTEN_COMPONENTWISE",CONTINUOUS_ON_FLATTEN_COMPONENTWISE;
...
"CONTINUOUS_ON_MATRIX_FLATTEN",CONTINUOUS_ON_MATRIX_FLATTEN;
...
"FL",FL;
"FLATTEN_0",FLATTEN_0;
"FLATTEN_ADD",FLATTEN_ADD;
"FLATTEN_CMUL",FLATTEN_CMUL;
"FLATTEN_COMPONENT",FLATTEN_COMPONENT;
"FLATTEN_EQ",FLATTEN_EQ;
"FLATTEN_EQ_0",FLATTEN_EQ_0;
"FLATTEN_GSPEC",FLATTEN_GSPEC;
"FLATTEN_LEMMA",FLATTEN_LEMMA;
"FLATTEN_MATRIFY",FLATTEN_MATRIFY;
"FLATTEN_SUB",FLATTEN_SUB;
"FLOOR",FLOOR;
...
"LIM_FLATTEN_COMPONENTWISE",LIM_FLATTEN_COMPONENTWISE;
...
"LIM_MATRIX_FLATTEN",LIM_MATRIX_FLATTEN;
...
"MATRIFY_FLATTEN",MATRIFY_FLATTEN;
...
"NORM_FLATTEN_HADAMARD_LE",NORM_FLATTEN_HADAMARD_LE;
"NORM_FLATTEN_MUL_LE",NORM_FLATTEN_MUL_LE;
"NORM_FLATTEN_ORTHOGONAL_MATRIX_LMUL",NORM_FLATTEN_ORTHOGONAL_MATRIX_LMUL;
"NORM_FLATTEN_ORTHOGONAL_MATRIX_RMUL",NORM_FLATTEN_ORTHOGONAL_MATRIX_RMUL;
"NORM_FLATTEN_POW_2",NORM_FLATTEN_POW_2;
"NORM_FLATTEN_TRANSP",NORM_FLATTEN_TRANSP;
...
"ONORM_LE_NORM_FLATTEN",ONORM_LE_NORM_FLATTEN;
"ONORM_NEG",ONORM_NEG;
